@extends('layouts.app') <!--ファイルを読み込む-->

@section('content')
	<div class="container">
		<div class="col-sm-offset-2 col-sm-8">
			<div class="panel panel-default">
				<div class="panel-heading">新しい書籍</div>
				...
				<div class="panel-body">
					...
					<form action="/book" method="POST" class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="text" name="name" id="book-name" class="form-control" value="{{ old('book') }}"> <!--エラーの時に記入したものを残す-->
							</div>
						</div>
